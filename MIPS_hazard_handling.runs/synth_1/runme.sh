...
HD_PWD='C:/Users/Atul/MIPS_hazard_handling/MIPS_hazard_handling.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_without_fwd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mips_without_fwd.tcl
