...
HD_PWD='C:/Users/Atul/MIPS_hazard_handling/MIPS_hazard_handling.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_without_fwd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mips_without_fwd.tcl -notrace
